const Footer = () => {
  return (
    <footer className="font-title flex justify-center items-center px-16 py-20 mt-36 w-full bg-[#991E66] max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <div className="mt-10 mb-3.5 w-full max-w-[1208px] max-md:max-w-full">
        <div className="flex gap-6 justify-center max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-center justify-center gap-6 max-md:mt-10">
              <h2 className="text-[32px] p-2 text-white font-title">
                Body Shop
              </h2>
            ...
            <div className="flex flex-col grow text-base text-white max-md:mt-6">
              ...
              <address className="flex gap-2 mt-6 not-italic">
                ...
                <span className="my-auto">
                  22, Ilerin Street, Lagos, Nigeria.
                </span>
              </address>
          ...
          <div className="flex flex-col max-md:ml-0 max-md:w-full">
            <div className="flex flex-col gap-6 justify-center items-center self-stretch text-base text-white max-md:mt-7">
              ...
              <form className="px-5 border border-[#FFB2E6] border-solid">
                ...
                <input
                  ...
                  id="email"
                  placeholder=""
                  className="w-[299px]  py-5 whitespace-nowrap bg-transparent placeholder:text-white"
