...
const Footer = () => {
  ...
  return (
    <footer className="font-title flex flex-col gap-10 items-center px-20 py-20 mt-36 bg-[#C80001] max-md:px-5 max-md:mt-10 max-md:max-w-full">
      ...
      <div className="flex flex-col grow mx-6 text-wrap text-base text-white max-md:mt-6">
      ...
      <div className="flex flex-col gap-6 justify-center items-center self-stretch text-base text-white max-md:mt-7">
        ...
        <form className=" w-full overflow-hidden flex justify-center shrink">
          ...
          <input
            ...
            id="email"
            placeholder="Email"
            className="rounded-l-lg px-4 py-4 text-[#c80001] text-xl outline-none bg-white font-semibold placeholder:text-[#c80001]"
